...
const onClick = (productID: string, productGroupID: string) => {
  ...
  if (user?.email) {
    ...
    window.alert(`Inicia sesión para guardar vehículos en Mi Garaje`);
  }
};
  ...
  return (
    <>
      <button
        ...
        disabled
        {...addToWishlistEvent}
        aria-label="Guardar en Mi Garaje"
      ...
      >
        ...
        {variant === "full" && (
          <span class="[.htmx-request_&]:hidden">Guardar en Mi Garaje</span>
        )}
